...
forstat: forpart1 DO statlist ENDLOOP {let (lquad, ident, step, quadnum) = $1
...
forpart1: FOR ident AFFECT expr STEP expr UNTIL expr {let (i1, e1, e2, e3, q1, q2) = ($2, fst $4, fst $6, fst $8, (currentquad()), (currentquad())) in
